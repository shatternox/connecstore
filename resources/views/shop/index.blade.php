        ...
        <div class="side-menu animate-dropdown outer-bottom-xs">
          ...
          <nav class="yamm megamenu-horizontal">
            <ul class="nav">
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon {{$cat->category_icon}}" aria-hidden="true"></i>{{$cat->category_name}}</a>
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
                      <div class="col-sm-12 col-md-3">
        ...
        <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
          <div class="more-info-tab clearfix ">
            ...
            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
              ...
              <li><a data-transition-type="backSlide" href="#{{$ca->category_slug}}" data-toggle="tab">{{$ca->category_name}}</a></li>
              @endforeach
          ...
          <div class="tab-content outer-top-xs">
                ...
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="{{ asset($pr->product_thumbnail) }}" alt=""></a> </div>
                          <!-- /.image -->

                          <div class="tag new"><span>What</span></div>
                        </div>
                        <!-- /.product-image -->

                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">{{$pr->product_name}}</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> ${{$pr->selling_price}} </span> <span class="price-before-discount">$ 800</span> </div>
                          <!-- /.product-price -->
            ...
            @foreach ($category as $ca)
            <div class="tab-pane" id="{{$ca->category_slug}}">
              <div class="product-slider">
